...
/* API to get the List of waiting tasks from a queue handle
 * @param[in] handle Handle of the queue
 * @param[out] List Pointer to the list of waiting tasks got from handle
 */
void vGetWaiterListFromHandle(const unsigned int *handle, unsigned int **List);
