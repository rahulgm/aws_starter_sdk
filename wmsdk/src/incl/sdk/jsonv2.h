 ...
 * In the above, "name", "JSON Parser", "vesion", etc. are all strings.
 ...
 * by the JSON parser. Please refer \ref jsonv2_usage for more information.
 *
 ...
 * be, please refer \ref jsonv2_usage section.
 ...
 * \return -WM_E_JSON_INVALID_JOBJ if the given json string is not a valid
 * JSON object.
